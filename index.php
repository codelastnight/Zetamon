...
<body>
  ...
  <div class='container main-body'>
    <h1 class="text-huge" style="padding-top: 4em">PRE PRE PRE PRE ALPHA SITE</h1>
    <section class="section">
      <h2 class="text-big">SUPER BUGGY</h2>
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <h2 class="text-medium text-gray">Dont expect too much at this stage. Im getting the framework done.</h2>
          <p> Dont expect too much at this stage. Im getting the framework done. /n Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
            exercitation
    ...
    <section class="section">
      <h2 class="text-big"> should trigger submenu </h2>
      <div class="row">
        <div class="col-xs-12 col-md-6" id="trigger-menu">
          <h2 class="text-medium text-gray">Default</h2>
          <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            Duis aute
            irure dolor <a href="#" title="in reprehenderit">in reprehenderit</a> in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
